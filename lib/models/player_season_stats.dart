...
/// Accumulates player statistics across all games in a season
class PlayerSeasonStats {
  ...
  PlayerSeasonStats addGameStats(PlayerGameStats gameStats) {
  ...
  /// Convert PlayerSeasonStats to JSON for serialization
  ...
  /// Create PlayerSeasonStats from JSON
  ...
  /// Create initial empty season stats for a player
  factory PlayerSeasonStats.empty(String playerId) {
    return PlayerSeasonStats(
      playerId: playerId,
      gamesPlayed: 0,
      totalPoints: 0,
